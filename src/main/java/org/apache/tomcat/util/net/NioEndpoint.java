...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void startInternal() throws Exception {
        ...
        if (!running) {
            ...
            log.info("Start poller threads pollerThreadCount="+ getPollerThreadCount());
        ...
        public void run() {
            ...
            while (true) {
                ...
                while (iterator != null && iterator.hasNext()) {
                    log.info("Poller iterator get SelectionKey");
...
<<<<<<< HEAD:src/main/java/org/apache/tomcat/util/net/NioEndpoint.java
            log.info("[d] processKey");
=======
>>>>>>> a6a38fdd45e314aa182a529771e5efa03b9dd113:java/org/apache/tomcat/util/net/NioEndpoint.java
            try {
                if ( close ) {
                    cancelledKey(sk);
                        ...
                        if ( attachment.getSendfileData() != null ) {
                            ...
                            if (sk.isReadable()) {
                                if (!processSocket(attachment, SocketEvent.OPEN_READ, true)) {
                                    log.info("SelectionKey is readable,it will create a thread to prosss ");
                                    closeSocket = true;
                                }
                            }
